...
namespace MusiVerse.GUI.UserControls
{
    public partial class ucPostCard : UserControl
    {
        ...
        private void DisplayPost()
        {
            ...
            // btnComment hoạt động qua btnComment_Click
            btnShare.Click += (s, e) => OnShareClicked?.Invoke(this, EventArgs.Empty);
        ...
        private Image CreateVideoThumbnail()
        {
            ...
            Bitmap bmp = new Bitmap(pbMedia.Width > 0 ? pbMedia.Width : 300, pbMedia.Height > 0 ? pbMedia.Height : 300);
        ...
        private void PlayVideoHandler(object sender, EventArgs e)
        {
            if (_post != null)
                PlayVideo(_post.MediaPath);
        }
