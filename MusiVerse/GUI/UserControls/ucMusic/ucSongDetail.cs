...
namespace MusiVerse.GUI.UserControls
{
    public partial class ucSongDetail : UserControl
    {
        ...
        public void LoadSongDetail(Song song)
        {
            ...
            // Set section titles
            lblFeaturedSongsTitle.Text = " Bài hát nổi bật của" + currentSong.ArtistName;
            lblAlbumsTitle.Text = " Album nổi bật của" + currentSong.ArtistName;
        ...
        private void LoadSongInfo()
        {
            ...
            lblArtist.Text = $"Nghệ sĩ: {currentSong.ArtistName}";
            lblGenre.Text = $"Thể loại: {currentSong.Genre}";
            lblReleaseDate.Text = $"Ngày phát hành: {currentSong.ReleaseDate:dd/MM/yyyy}";
            lblDuration.Text = $"Thời lượng: {FormatDuration(currentSong.Duration)}";
            lblPlayCount.Text = $"{currentSong.PlayCount:N0} lượt nghe";
        ...
        private void LoadArtistFeaturedSongs()
        {
            ...
            if (artistSongs.Count == 0)
            {
                ...
                {
                    Text = "Không có bài hát nổi bật nào",
        ...
        private void LoadArtistAlbums()
        {
            ...
            if (artistAlbums.Count == 0)
            {
                Label lblEmpty = new Label
                {
                    Text = "Không có album nổi bật  nào",
                    Font = new Font("Segoe UI", 11),
                    ForeColor = Color.Gray,
                    AutoSize = true
                };
